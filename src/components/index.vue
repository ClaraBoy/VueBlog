  ...
  <div>
    ...
    <div class="slideshow mid">
      ...
      <div class="slide">
        ...
        <div class="box_sb1 sc2">
          <p :class="{pText:ispText,pText2:ispText2}">Vue CLI 是一个基于 Vue.js 进行快速开发的完整系统，提供：
      ...
      <div class="nav">
        ...
        <label for="r3" class="bar" @click="but(3)"></label>
        <label for="r4" class="bar" @click="but(4)"></label>
